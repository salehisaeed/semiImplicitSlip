...
#include "simpleKaplanRUShroudVelocityDirichletBCPointPatchVectorField.H"
...
simpleKaplanRUShroudVelocityDirichletBCPointPatchVectorField
(
    const simpleKaplanRUShroudVelocityDirichletBCPointPatchVectorField& ptf,
    const pointPatch& p,
    const DimensionedField<vector, pointMesh>& iF,
...
void simpleKaplanRUShroudVelocityDirichletBCPointPatchVectorField::autoMap
(
...
void simpleKaplanRUShroudVelocityDirichletBCPointPatchVectorField::rmap
(
    const pointPatchField<vector>& ptf,
    const labelList& addr
)
{
    const simpleKaplanRUShroudVelocityDirichletBCPointPatchVectorField& aODptf =
        refCast<const simpleKaplanRUShroudVelocityDirichletBCPointPatchVectorField>(ptf);
...
void simpleKaplanRUShroudVelocityDirichletBCPointPatchVectorField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void simpleKaplanRUShroudVelocityDirichletBCPointPatchVectorField::write
(
    Ostream& os
) const
{
